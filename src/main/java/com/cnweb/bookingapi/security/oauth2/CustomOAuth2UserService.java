...
import com.cnweb.bookingapi.exception.OAuth2AuthenticationProcessingException;
...
import com.cnweb.bookingapi.security.oauth2.user.OAuth2UserInfo;
import com.cnweb.bookingapi.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        User user = new User();
        user.setRole(roleRepository.findByName(ERole.USER).orElseThrow());
